...
public class ActusController implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		engine.load("https://www.france24.com/fr/direct");
		...
		date.setText("Aujourd'hui le "+jours[now.getDayOfWeek().getValue()-1]+" "+now.getDayOfMonth()+" "+mois[now.getMonthValue()]+" "+now.getYear()+" il est "+dtf.format(now));
